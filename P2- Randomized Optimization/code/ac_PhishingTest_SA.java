...
public class ac_PhishingTest_SA {
    ...
    public static void main(String[] args) {
        ...
        int[] ITER = {10, 100, 500, 1000, 2500, 5000 ,8000};                       // Iterations
        double[] T = {0.15, 0.25, 0.35, 0.45, 0.55, 0.65, 0.75, 0.85, 0.95};    // Temperature

        System.out.println("SA, iter, temp, train_acc, test_acc, train-time, test-time ");

        for (int train_it : ITER) {

            for (double temp : T) {

                //System.out.println( "temp = " + temp + "  iter= " + train_it);

                oa[0] = new SimulatedAnnealing(1E11, temp , nnop[0]);
                ...
                /***********  Print Results  ******************/
                results = oaNames[0] + ", " + train_it + ", " + temp + ", "+ df.format(train_acc) + ", " + df.format(test_acc) + ", " +
